...
class Ui_MainWindow1(object):
    ...
    start_time = 0
    index = 1
     #GUI developing for application..
    def setupUi_1(self,MainWindow,ques,options,client,ui):   
        ...
        # timer is used to update the time..
    ...
    def updateTimer(self,client,ui,MainWindow,timer):
     ...
     #question index updating function..
    ...
    #provides series of steps to be done on clicking submit button..
    def onSubmit(self,client,ui,MainWindow,timer):
        ...
        #calling the receive message function defined in client side code..
